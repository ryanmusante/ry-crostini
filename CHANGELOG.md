...
- `run-x86`, `gog-extract`, `run-game` wrappers now carry `# ry-crostini:VERSION` markers and grep-gated re-write. SCRIPT_VERSION bumps now refresh wrappers; previously they permanently reported whichever version first installed them.
